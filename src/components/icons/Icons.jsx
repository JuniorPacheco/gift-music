    ...
    >
      <g clipPath="url(#clip0_5713_1903)">
        <path
          ...
          fill="white"
          className="group-hover:fill-yellow-p transition-colors"
        />
        <path
...
export const IconAdd = () => {
  return (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <g clipPath="url(#clip0_5713_1893)">
        <path
  ...
  return (
    ...
    >
      <path
        ...
        strokeWidth="2"
        strokeLinecap="round"
        className="group-hover:stroke-yellow-p transition-colors"
        strokeLinejoin="round"
      />
    </svg>
  );
